...
public class PathActivity extends AppCompatActivity {
    ...
    @OnClick({R.id.line_btn, R.id.base_shaper_btn,R.id.acr_btn,R.id.bezier_2_btn,R.id.bezier_3_btn,R.id.other_btn,R.id.boolean_operation_btn,R.id.path_measure_btn,R.id.path_measure2_btn})
